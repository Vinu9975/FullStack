      ...
      userInfo = (
        <div >
          <Alert >
              ...
              <hr></hr>
              {/* component for single searchbarr to search all field */}
              {/* if you want use thise then comment bellow BasicTable component */}
              {/* <BasicTable1 user={user}/> */}

              {/* component for serch particuler field in columan that user want */}
              {/* if you want use thise then comment above BasicTable1 component */}
